...
/**
 * Provides data fields and methods to create a Java client that communicates with a server that identifies whether or not a
...
public class Client {
	 ...
	 * @param portNumber the palidrome server's port number
	 */
...
/**
 * This is the main method that is runned when a client is runned. It creates a client that connects to the local host at port number 8099.
